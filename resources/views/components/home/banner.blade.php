        ...
        <div class="container-fluid col-padding-0">
          <div class="row align-items-center">
            <div class="col-sm-12 col-md-12 col-lg-5">
              <div class="banner-panel">
                <div class="heading-layout2 mb-40">
                  ...
                  <p class="heading__desc">You deserve Expert service, and with us, it’s right in the name. 
                    We are Service Experts! Delivering comfort for our communities and making a difference in people’s lives.</p>
                </div><!-- /.heading -->
                <div class="row">
                  <!-- fancybox item #1 -->
            ...
            <div class="col-sm-12 col-md-12 col-lg-7">
              <img src="{{ asset('assets/images/banners/3.jpg')}}" alt="banner" class="w-100">
            </div><!-- /.col-lg-6 -->
          </div><!-- /.row -->
        </div><!-- /.container -->
    </section>
